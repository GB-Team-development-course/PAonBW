...
public enum OrderStatus {
	...
	IN_PROGRESS(1, "В исполнении"), REJECTED(2, "Отказ"), //Ошибка со строны Клиента
	SUCCESS(3, "Успешно"), ERROR(4, "Ошибка"); // Ошибка со стороны сервиса

	private static final Map<Integer, OrderStatus> LOOKUP_BY_ID = Stream.of(OrderStatus.values()).collect(Collectors.toMap(OrderStatus::getId, Function.identity()));
