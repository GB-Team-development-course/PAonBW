...
public enum Currency {
	...
	USD(1, 840, "Доллар США"), RU(2, 810, "Российский рубль");

	private final static Map<Integer, Currency> LOOKUP_BY_ID = Stream.of(Currency.values()).collect(Collectors.toMap(Currency::getId, Function.identity()));
